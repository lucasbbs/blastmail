...
<div
  @class([ 'relative w-full overflow-hidden rounded-xl border bg-white text-slate-700 dark:bg-slate-900 dark:text-slate-300'
  ...
  role="alert">
  <div @class([ 'flex w-full items-center gap-2 p-4' , 'bg-green-500/10'=> $success,
    'bg-sky-500/10' => $info,
