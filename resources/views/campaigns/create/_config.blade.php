<div class="grid grid-cols-2 gap-4">
  ...
  <div>
    <x-input.checkbox id="track_click" name="track_click" autofocus value="1"
      :isCheckedWhen="old('track_click', $data['track_click'])" :label="__('Track Click')" />
    <x-input-error :messages="$errors->get('track_click')" class="mt-2" />
  </div>

  <div>
    <x-input.checkbox id="track_open" name="track_open" autofocus value="1"
      :isCheckedWhen="old('track_open', $data['track_open'])" :label="__('Track Open')" />
